...
public:
  ...
  // Mark icon as streamed directly to the display (lives only in GRAM).
  // isReady() becomes true; draw() stays a no-op so the placeholder
  // never paints over the streamed pixels.
  void markStreamed();
